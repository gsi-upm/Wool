...
<div class="dragContainer" data-bind="visible: !editionFinished()">
  ...
  <div class="channelTabs">
    <div class="spaceButtons" data-bind="foreach: spaces">
      <!-- ko if: $index() == 0 -->
      <div><button class="greenTab" data-bind="attr: {id: 'allSpaces'}, text: $root.lang().allChannels, click: $root.selectSpace.bind($data, 'allSpaces'), 
          css: {greenTabSelected: $root.selectedTab() == 'allSpaces'}"></button></div>
      <!-- /ko -->
