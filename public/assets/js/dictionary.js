languages =
    [
		...
		m6: "Orden alfabético",
		m7: "Orden semántico",
                m8: "Notificación de rule editor",
		...
		channels: "Canales",
		rules: "Reglas",
		field: "Campo de pruebas",
		logout: "Salir",
		logged: "Registrado como ",
		marg1: "20px",
		marg2: "280px",
		saveRule: "Guardar Regla",
		cancelRule: "Cancelar",
		backToRules: "Volver a la lista de reglas",
		backToEdit: "Editar otra regla",
		submit: "Guardar",
		name:"Nombre",
		description:"Descripción",
		logo:"Logo",
		channelHelp1: "Detalles del canal",
		...
		web_service: "Servicios de Internet",
		lab_gsi: "Laboratorio del GSI",
		home: "Casa",
		beginner:"básico",
...
                      + "You can then click on each box of the entity to see the companies that correspond to the selected fields in the search. ",
		...
		backToEdit: "Edit another rule",
		submit: "Submit",
		name:"Name",
		description:"Description",
		logo:"Logo",
		channelHelp1: "Channels details",
